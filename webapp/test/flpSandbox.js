		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "High Noon Gamble V2.0",
									"targetURL": "#HNGv2highnoongamble-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"HNGv2highnoongamble-display": {
								"semanticObject": "HNGv2highnoongamble",
								"action": "display",
								"description": "High Noon Gamble Tools V2.0",
								"title": "High Noon Gamble V2.0",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=HNGv2.highnoongamble",
									"url": sap.ui.require.toUrl("HNGv2/highnoongamble")
								}
							}
						}
					}
